...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2023 at 05:39 AM
...
(1, 'Singer TV', 1, 'sadeera123', '', '', '2023-09-11 08:01:29', 'To Udana');
...
--
ALTER TABLE `issued_items`
  ADD CONSTRAINT `fk_issued_by` FOREIGN KEY (`Issued_by`) REFERENCES `users` (`username`);
