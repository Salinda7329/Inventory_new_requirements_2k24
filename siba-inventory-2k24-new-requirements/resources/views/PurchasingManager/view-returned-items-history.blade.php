        ...
        <div class="authentication-wrapper authentication-basic container-p-y">
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="show_accepted_items_data"></div>
                    </div>
                </div>
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        fetchAllReturnsHistoryPM();


                        function fetchAllReturnsHistoryPM() {
                            $.ajax({
                                url: '{{ route('fetchAllReturnsHistoryPM') }}',
                                type: 'post',
                                headers: {
                                ...
                                success: function(html) {
                                    ...
                                    $('#show_accepted_items_data').html(html);
